...
static const char kShellTypes0[] =
    R"GPUI_DTS(// Auto-generated — add `gpui.d.ts` to your .gitignore.
//
...
static const char kShellTypes1[] =
    R"GPUI_DTS(   * host call and reports clearly once that call has returned — which is what
...
static const char kShellTypes2[] =
    R"GPUI_DTS(     * is completely unstyled — no size, no content — so a number input that
...
static const char kShellTypes3[] =
    R"GPUI_DTS(    on_dismiss(handler: (event: {}, cx: Context) => void): Element;
    /**
...
static const char kShellTypes4[] =
    R"GPUI_DTS(     * Which corner of a `Popover` or `HoverCard` is pinned to its trigger, or
    ...
    /** Whether an fps_monitor requests continuous whole-window redraws. Default true; pass false to observe application frames. */
...
static const char kShellTypes5[] =
    R"GPUI_DTS(    rounded_t(value: AbsoluteLength): Element;
...
static const char kShellTypes7[] =
    R"GPUI_DTS(     * Sets the border width of the horizontal sides of the element. [Docs](https://tailwindcss.com/docs/border-width#horizontal-and-vertical-sides)
     *
     * 8px
     */
    border_y_8(): Element;
...
static const char kShellTypes20[] =
    R"GPUI_DTS(     * Sets the maximum height of the element. [Docs](https://tailwindcss.com/docs/max-height)
     *
     * 25% (1/4)
     */
...
static const char kShellTypes25[] =
...
static const char kShellTypes26[] =
    R"GPUI_DTS(     * Sets the minimum width and height of the element.
     *
     * 80px (5rem)
     */
...
static const char kShellTypes28[] =
...
static const char kShellTypes30[] =
    R"GPUI_DTS(     * Sets the right margin of the element. [Docs](https://tailwindcss.com/docs/margin#add-margin-to-a-single-side)
     *
     * 128px (8rem)
     */
...
static const char kShellTypes31[] =
...
static const char kShellTypes36[] =
    R"GPUI_DTS(     * Sets the bottom padding of the element. [Docs](https://tailwindcss.com/docs/padding#add-padding-to-a-single-side)
     *
     * 40% (2/5)
     */
    pb_2_5(): Element;
...
static const char kShellTypes39[] =
    R"GPUI_DTS(     * Sets the right padding of the element. [Docs](https://tailwindcss.com/docs/padding#add-padding-to-a-single-side)
     *
     * 80% (5/6)
     */
    pr_5_6(): Element;
...
static const char kShellTypes42[] =
...
static const char kShellTypes43[] =
    R"GPUI_DTS(     * Sets the vertical padding of the element. [Docs](https://tailwindcss.com/docs/padding#add-vertical-padding)
     *
     * 12px (0.75rem)
     */
    py_3(): Element;
...
static const char kShellTypes45[] =
    R"GPUI_DTS(     * Sets the right value of a positioned element. [Docs](https://tailwindcss.com/docs/top-right-bottom-left)
     *
     * 66% (2/3)
     */
...
static const char kShellTypes48[] =
    R"GPUI_DTS(     * [Docs](https://tailwindcss.com/docs/font-size#setting-the-font-size)
     */
    text_base(): Element;
...
static const char kShellTypes52[] =
    R"GPUI_DTS(  export interface TextViewElement extends Element {
...
static const char kShellTypes53[] =
    R"GPUI_DTS(  export const TableRow: { new: (id: string | number, row_index: number) => Element };
...
static const char kShellTypes54[] =
    R"GPUI_DTS(   * * **No state inside the renderer.** `InputState.new()`, `cx.focus_handle()`
...
static const char kShellTypes55[] =
    R"GPUI_DTS(    /** The digits entered so far — shorter than `len()` until the code is complete. */
    value(): string;
    /**
...
static const char kShellTypes56[] =
    R"GPUI_DTS(    tab_bar(handler: (group: DockGroup, cx: Context) => Element): DockAreaElement;
...
static const char kShellTypes57[] =
    R"GPUI_DTS(  export function mkdir(path: string, options?: MakeDirectoryOptions): Promise<void>;
}
declare module "net" {
...
void AppendBuiltinTypeDeclarations(StrBuilder* out) {
    out->Append(Str(kShellTypes0, (int)sizeof(kShellTypes0) - 1));
    out->Append(Str(kShellTypes1, (int)sizeof(kShellTypes1) - 1));
    out->Append(Str(kShellTypes2, (int)sizeof(kShellTypes2) - 1));
    out->Append(Str(kShellTypes3, (int)sizeof(kShellTypes3) - 1));
    out->Append(Str(kShellTypes4, (int)sizeof(kShellTypes4) - 1));
    out->Append(Str(kShellTypes5, (int)sizeof(kShellTypes5) - 1));
    out->Append(Str(kShellTypes6, (int)sizeof(kShellTypes6) - 1));
    out->Append(Str(kShellTypes7, (int)sizeof(kShellTypes7) - 1));
    out->Append(Str(kShellTypes8, (int)sizeof(kShellTypes8) - 1));
    out->Append(Str(kShellTypes9, (int)sizeof(kShellTypes9) - 1));
    out->Append(Str(kShellTypes10, (int)sizeof(kShellTypes10) - 1));
    out->Append(Str(kShellTypes11, (int)sizeof(kShellTypes11) - 1));
    out->Append(Str(kShellTypes12, (int)sizeof(kShellTypes12) - 1));
    out->Append(Str(kShellTypes13, (int)sizeof(kShellTypes13) - 1));
    out->Append(Str(kShellTypes14, (int)sizeof(kShellTypes14) - 1));
    out->Append(Str(kShellTypes15, (int)sizeof(kShellTypes15) - 1));
    out->Append(Str(kShellTypes16, (int)sizeof(kShellTypes16) - 1));
    out->Append(Str(kShellTypes17, (int)sizeof(kShellTypes17) - 1));
    out->Append(Str(kShellTypes18, (int)sizeof(kShellTypes18) - 1));
    out->Append(Str(kShellTypes19, (int)sizeof(kShellTypes19) - 1));
    out->Append(Str(kShellTypes20, (int)sizeof(kShellTypes20) - 1));
    out->Append(Str(kShellTypes21, (int)sizeof(kShellTypes21) - 1));
    out->Append(Str(kShellTypes22, (int)sizeof(kShellTypes22) - 1));
    out->Append(Str(kShellTypes23, (int)sizeof(kShellTypes23) - 1));
    out->Append(Str(kShellTypes24, (int)sizeof(kShellTypes24) - 1));
    out->Append(Str(kShellTypes25, (int)sizeof(kShellTypes25) - 1));
    out->Append(Str(kShellTypes26, (int)sizeof(kShellTypes26) - 1));
    out->Append(Str(kShellTypes27, (int)sizeof(kShellTypes27) - 1));
    out->Append(Str(kShellTypes28, (int)sizeof(kShellTypes28) - 1));
    out->Append(Str(kShellTypes29, (int)sizeof(kShellTypes29) - 1));
    out->Append(Str(kShellTypes30, (int)sizeof(kShellTypes30) - 1));
    out->Append(Str(kShellTypes31, (int)sizeof(kShellTypes31) - 1));
    out->Append(Str(kShellTypes32, (int)sizeof(kShellTypes32) - 1));
    out->Append(Str(kShellTypes33, (int)sizeof(kShellTypes33) - 1));
    out->Append(Str(kShellTypes34, (int)sizeof(kShellTypes34) - 1));
    out->Append(Str(kShellTypes35, (int)sizeof(kShellTypes35) - 1));
    out->Append(Str(kShellTypes36, (int)sizeof(kShellTypes36) - 1));
    out->Append(Str(kShellTypes37, (int)sizeof(kShellTypes37) - 1));
    out->Append(Str(kShellTypes38, (int)sizeof(kShellTypes38) - 1));
    out->Append(Str(kShellTypes39, (int)sizeof(kShellTypes39) - 1));
    out->Append(Str(kShellTypes40, (int)sizeof(kShellTypes40) - 1));
    out->Append(Str(kShellTypes41, (int)sizeof(kShellTypes41) - 1));
    out->Append(Str(kShellTypes42, (int)sizeof(kShellTypes42) - 1));
    out->Append(Str(kShellTypes43, (int)sizeof(kShellTypes43) - 1));
    out->Append(Str(kShellTypes44, (int)sizeof(kShellTypes44) - 1));
    out->Append(Str(kShellTypes45, (int)sizeof(kShellTypes45) - 1));
    out->Append(Str(kShellTypes46, (int)sizeof(kShellTypes46) - 1));
    out->Append(Str(kShellTypes47, (int)sizeof(kShellTypes47) - 1));
    out->Append(Str(kShellTypes48, (int)sizeof(kShellTypes48) - 1));
    out->Append(Str(kShellTypes49, (int)sizeof(kShellTypes49) - 1));
    out->Append(Str(kShellTypes50, (int)sizeof(kShellTypes50) - 1));
