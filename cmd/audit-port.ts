...
const pinnedGpuiComponent = "122c36f7be19ea0e179107c067b679efccb7d66a";
...
const surfacePins: Record<CrateName, Record<SurfaceKind, { count: number; sha256: string }>> = {
  ...
  ui: {
    ...
    test: { count: 567, sha256: "b6ae35e0cc4be646d25b0190478638ebe184327263a85e04785ef7475ef1b070" },
  },
};
