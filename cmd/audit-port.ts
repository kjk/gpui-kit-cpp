...
const pinnedGpuiComponent = "ecb10948c55ed977b774eef6f2b7bb084d7710a6";
...
const surfacePins: Record<CrateName, Record<SurfaceKind, { count: number; sha256: string }>> = {
  base: {
    ...
    test: { count: 773, sha256: "1a6e8be3272340f282f34b4b81095c434a7438ab7e0ea81617bdedfb8caff820" },
  },
  ui: {
