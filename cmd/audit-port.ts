...
const pinnedGpuiComponent = "4a654f45011da1edacb0a2ffa094d901dc97333d";
...
const surfacePins: Record<CrateName, Record<SurfaceKind, { count: number; sha256: string }>> = {
  base: {
    ...
    test: { count: 771, sha256: "4dcd9b54f56e0ff57a2063bed8fff5d7d9d72ef27dc5053a56d174fa0f5d2afa" },
  },
  ui: {
    ...
    test: { count: 439, sha256: "6cf8a8ff79b755e1c2b1f57b7bd4011c1dc1ae1ef2a678a2b509d8bf0817ea0b" },
  },
};
